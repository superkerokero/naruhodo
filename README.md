...
Dependency structure graph is not immediately useful to humans or computers, but it is important information and can be used to generate knowledge-graph(KG) that will be introduced later.
